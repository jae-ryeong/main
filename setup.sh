...
docker build --tag 2mukee/mh_main_deploy:1.0 /var/lib/jenkins/workspace/mohaemookji/main
docker build --tag 2mukee/mh_api_deploy:1.0 /var/lib/jenkins/workspace/mohaemookji/api
docker build --tag 2mukee/mh_db_deploy:1.0 /var/lib/jenkins/workspace/mohaemookji
